...
<https://github.com/CodeforLeipzig/fog/issues>`_.
...
fog could always use more documentation, whether as
part of the official fog docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `fog` for
local development.

1. Fork the `fog` repo on GitHub.
2. Clone your fork locally:

    ::

       $ git clone git@github.com:your_name_here/fog.git
...
3. The pull request should work for Python 2.7 and 3.5. Check
   `Travis CI <https://travis-ci.org/CodeforLeipzig/fog/pull_requests>`_
